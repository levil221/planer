...
public class StaticResources {
    ...
    private static void addTestReservations() {
        addItemToDatabase(new Reservation(LocalDateTime.now(),15, ReservationStatus.pending,getRoomFromDatabase("P4.1"),"test1","test1"));
        addItemToDatabase(new Reservation(LocalDateTime.now(),15, ReservationStatus.pending,getRoomFromDatabase("P5.2"),"test2","test2"));
        addItemToDatabase(new Reservation(LocalDateTime.now(),15, ReservationStatus.pending,getRoomFromDatabase("P1.1"),"test3","test3"));
        addItemToDatabase(new Reservation(LocalDateTime.now(),15, ReservationStatus.pending,getRoomFromDatabase("P1.2"),"test4","test4"));
    }
    ...
    private static void addItemToDatabase(Object obj){
        EntityManager entityManager = ResourceManager.getEntityManagerFactory().createEntityManager();
